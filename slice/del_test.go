...
func TestFilterDel(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			slice:   []int{},
			filter:  func(idx int, elem int) bool { return true },
			wantRes: []int{},
		}, {
			name:    "delete nothing",
			slice:   []int{1, 2, 3},
			filter:  func(idx int, elem int) bool { return false },
			wantRes: []int{1, 2, 3},
		}, {
			name:    "delete all",
			slice:   []int{1, 2, 3},
			...
			slice:   []int{1, 2, 3},
			filter:  func(idx int, elem int) bool { return idx == 0 },
			wantRes: []int{2, 3},
		}, {
			name:    "delete last element",
			slice:   []int{1, 2, 3},
			filter:  func(idx int, elem int) bool { return idx == 2 },
			wantRes: []int{1, 2},
		}, {
			name:    "delete first and last element",
			slice:   []int{1, 2, 3},
			filter:  func(idx int, elem int) bool { return idx == 0 || idx == 2 },
			wantRes: []int{2},
		}, {
			name:    "delete middle element",
			slice:   []int{1, 2, 3},
			filter:  func(idx int, elem int) bool { return idx == 1 },
			wantRes: []int{1, 3},
		}, {
			name:    "delete all elements that are even",
			slice:   []int{1, 2, 3, 4, 5, 6},
			filter:  func(idx int, elem int) bool { return elem%2 == 0 },
			wantRes: []int{1, 3, 5},
		}, {
			name:    "delete first three elements",
			slice:   []int{1, 2, 3, 4, 5, 6},
			filter:  func(idx int, elem int) bool { return idx < 3 },
			wantRes: []int{4, 5, 6},
		}, {
